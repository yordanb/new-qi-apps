    ...
    try {
      ...
      if (data != null && data['response'] != null) {
        setState(() {
          ...
          // Cek jika data adalah "belum akses jarvis"
          if (data['response']['data2'] ==
              "b|e|l|u|m| |a|k|s|e|s| |j|a|r|v|i|s") {
            belumAksesJarvis = true;
          }
